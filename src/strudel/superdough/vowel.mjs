...
export var vowelFormant = {
  ...
  ae: {
    freqs: [650, 1515, 2400, 3000, 3350],
    gains: [1, 0.5, 0.1008, 0.0631, 0.0126],
    qs: [80, 90, 120, 130, 140],
  },
  aa: {
    freqs: [560, 900, 2570, 3000, 3300],
    gains: [1, 0.5, 0.0708, 0.0631, 0.0126],
    qs: [80, 90, 120, 130, 140],
  },
  oe: {
    freqs: [500, 1430, 2300, 3000, 3300],
    gains: [1, 0.2, 0.0708, 0.0316, 0.01995],
    qs: [40, 60, 100, 120, 120],
  },
  ue: {
    freqs: [250, 1750, 2150, 3200, 3300],
    gains: [1, 0.1, 0.0708, 0.0316, 0.01995],
    qs: [40, 60, 100, 120, 120],
  },
  y: {
    freqs: [400, 1460, 2400, 3000, 3300],
    gains: [1, 0.2, 0.0708, 0.0316, 0.02995],
    qs: [40, 60, 100, 120, 120],
  },
  uh: {
    freqs: [600, 1250, 2100, 3100, 3500],
    gains: [1, 0.3, 0.0608, 0.0316, 0.01995],
    qs: [40, 70, 100, 120, 130],
  },
  un: {
    freqs: [500, 1240, 2280, 3000, 3500],
    gains: [1, 0.1, 0.1708, 0.0216, 0.02995],
    qs: [40, 60, 100, 120, 120],
  },
  en: {
    freqs: [600, 1480, 2450, 3200, 3300],
    gains: [1, 0.15, 0.0708, 0.0316, 0.02995],
    qs: [40, 60, 100, 120, 120],
  },
  an: {
    freqs: [700, 1050, 2500, 3000, 3300],
    gains: [1, 0.1, 0.0708, 0.0316, 0.02995],
    qs: [40, 60, 100, 120, 120],
  },
  on: {
    freqs: [500, 1080, 2350, 3000, 3300],
    gains: [1, 0.1, 0.0708, 0.0316, 0.02995],
    qs: [40, 60, 100, 120, 120],
  },
  get æ() {
