...
CodeMirror.defineMode('strudel', function (config, parserConfig) {
  var indentUnit = config.indentUnit
  var statementIndent = parserConfig.statementIndent
  var jsonldMode = false
  var jsonMode = false
  var isTS = false
...
CodeMirror.registerHelper('wordChars', 'strudel', /[\w$]/)

CodeMirror.defineMIME('text/strudel', 'strudel')
